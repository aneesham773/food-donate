...
<head>
    ...
    <title>Vegetable and Fruits</title>
</head>
  ...
  <!-- Navbar links -->
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="veggies.php">Products</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row mt-2 pb-3">
            <?php
                include 'config.php';
                $stmt=$conn->prepare("SELECT * FROM vegetable_fruits");
                $stmt->execute();
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
                <div class="card-deck">
                    <div class="card p-2 border-sec mb-2">
                        ...
                        <div class="card-body p-1">
                            ...
                            <h6 class="card-text text-center text-info"> <?=$row['product_weight'] ?></h6>
                        </div>
